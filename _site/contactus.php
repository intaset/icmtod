...
<title>ICMTOD'17 - Contact Us</title>
...
<div id="content">
  ...
  <div class="cbp-af-inner">
    <div class="unit unit-s-3-4 unit-m-1-3 unit-l-1-3">
      ...
      <div class="unit unit-s-1-3 unit-m-2-3 unit-m-2-3-1 unit-l-2-3">
        ...
        <div class="bg">
          <h1>2<sup>nd</sup> International Conference on Mass<br>Transfer Operation and Devices (ICMTOD'17)</h1>
 ...
 <div class="unit unit-s-3-4 unit-m-3-4 unit-l-3-4">
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      <h2 class="title">1</h2>
      <p class="bold">ICMTOD 2017:</p>
      <p class="body">ICMTOD 2017 will  be held in Barcelona, Spain on April 7 - 8, 2017.</p>

      <p class="bold">Poster Board Dimensions:</p>
      <p class="body">Authors presenting via poster boards are to be informed that poster boards are 130 cm height and 90 cm width.</p>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  <div class="unit-spacer content">
    ...
    Thank you for your interest in ICMTOD'17.</p>
  </div>
</div>
...
<footer id="contact">
  ...
  <div class="unit-spacer">
  <p class="body">For questions or comments regarding ICMTOD'17, please fill out the form below:</p>
