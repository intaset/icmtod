<?php
$my_email = "registration@icmtod.com";
$errors = array();
...
Thank you for registering for ICMTOD 2016. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your camera ready version and a signed copyright form via email to info@icmtod.com. You can find the copyright form here: www.icmtod.com/papers. Please note that failing to do so may result in an unsuccessful process of your registration.

You can find your registration details below. If there are any errors in the information you have provided, please write an email to us at registration@icmtod.com mentioning the correct information. Please note that you SHOULD NOT refill the form.
...
$your_headers = "From: ICMTOD'16 <" . $my_email . ">";

$your_email = $_REQUEST['Email'];

$your_subject = "Your Registration Details for ICMTOD'16";
...
<meta name="keywords" content="mass transfer conference, mass transfer operation conference, mass transfer devices conference, distillation conference, drying conference, leaching conference, extraction conference, porous media conference, molecular diffusion conference, separation process conference, catalytic reaction conference, membrane conference, mass transfer, mass transfer operation, mass transfer devices, distillation, drying, leaching, extraction, porous media, molecular diffusion, separation process, catalysis, membrane, catalytic reaction, catalysis conference, chemical engineering, chemical engineering conference, Distillation, Drying, Extraction Process, Gas Liquid and Gas Solid Operations, Leaching, Liquid-Liquid and Liquid-Solid Operations, Mass Transfer Coefficient, Mass Transfer in Porous Media, Mass Transfer with or without Reaction, Measurement Techniques, Membrane Fundamentals and Operations, Molecular Diffusion, Separation Processes, distillation, drying, extraction, gas liquid, liquid liquid, gas solid, liquid solid, leaching, mass transfer, mass transfer coefficient, mass transfer in porous media, mass transfer with reaction, mass transfer without reaction, reaction, measurement techniques, membrane, desalination, molecular diffusion, separation, separation process, Fick's law, Fick law, modelling, biomedical mass transfer, transport phenomena, spray system, adsorption, absorption, transport process, evaporation, boiling, condensation, cooling towers, towers, crystal growth, binary diffusion, thermodiffusion, chemical engineering, applied chemistry, Crystallization, Electrophoresis, flotation, liquid-liquid extraction, precipitation, scrubbing, sedimentation, gravity separation, sieving, sieve tray, bubble cap, sublimation, analytical chemistry, chromatography, mixture, Separation of Mixtures Using Different Techniques, Separation of Components of a Mixture, fractional distillation, filtration, magnetic separation, unit operation, ideal gas, Gibb’s Phase Rule, Raoult’s Law, Henry’s Law, Raoult’s Law vs Henry’s Law, Vapor-Liquid Equilibrium in Nonideal Solutions, Vapor-Solid Equilibrium, Liquid-Solid Equilibrium, Diffusion in Gases, Diffusion in Liquids, Immiscible Phases, Humidification, Miscible Phases, flash distillation, batch distillation, packed column distillation, multicomponent distillation, stripping, regeneration, equilibrium, spray dryers, rotary dryers, microfiltration, cyclones, centrifugation, international aset, mass transfer operation, icm conference, nd international, aset international, mass transfer, Aero-thermodynamics, Biological heat and mass transfer, Cryogenics, Energy engineering, Experimental techniques, Heat transfer equipments, Mass transfer, Microscale and nanoscale transport, Multi mode heat transfer, Refrigeration and air conditioning, Transport phenomena in porous media, Atmospheric flows, Combustion and reactive flows, Electronic and photonic cooling, Environmental engineering, Heat transfer enhancement, Heat transfer in nuclear applications, Materials processing and manufacturing, Multiphase transport and phase change, Numerical methods, Space heat transfer, Turbulent transport, Discrete methods, Lattice Boltzmann method, Molecular dynamic simulations, Monte Carlo method, Cellular automata, Recent developments on Navier-Stokes equations solvers, Validation of computational methods, Multi-phases, gas-liquid, liquid-solid, etc., Solidification and melting, Complex chemical reaction modeling, Reactive flows and combustion, Internal flow and heat transfer, Double diffusive convection">
<title>ICMTOD'16 - Registration Form Filled!</title>
...
<div id="content">
  ...
  <header>
	...
	<div class="cbp-af-inner">
        ...
        <div class="bg">
          <h1>International Conference on Mass<br>Transfer Operation and Devices (ICMTOD'16)</h1>
 ...
 <div class="unit unit-s-3-4 unit-m-3-4 unit-l-3-4">
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      <h2 class="title">1</h2>
      <p class="bold">ICMTOD 2016:</p>
      <p class="body">ICMTOD 2016 will  be held in Ottawa, Canada on April 4 - 5, 2016.</p>
    </div>          
    <div>
      <h2 class="title">2</h2>
  ...
  <div class="unit-spacer content">
    ...
    <p class="body">If you do not receive an email, <strong>please check your SPAM folder</strong>.</p>
 	...
 	<p class="body">If you have requested any official invitation letters, please allow up to 5 business days to receive your documents.</p> 
  	...
  	<p class="body">If there are any problems in the information you have filled out, please write an email to us at <a href="mailto:registration@icmtod.com" class="body-link">registration@icmtod.com</a> mentioning the mistakes made. Please note that you SHOULD NOT refill the form.</p>

	<p class="body">We are looking forward to seeing you at ICMTOD'16!</p>
  </div>
</div>
...
<footer id="contact">
	...
	<div class="unit-spacer">
	<p class="body">For questions or comments regarding ICMTOD'16, please fill out the form below:</p>
